...
export const ROUTE_ROLES = [
  ...
  { method: 'POST', path: '/api/auth/logout', fsm: true, manager: true, admin: true, executive: true },
  { method: 'GET', path: '/api/auth/me', fsm: true, manager: true, admin: true, executive: true },
  { method: 'POST', path: '/api/auth/switch-org', fsm: true, manager: true, admin: true, executive: true },
  ...
  { method: 'GET', path: '/api/dashboard', fsm: 'own', manager: true, admin: true, executive: true },
  { method: 'GET', path: '/api/attention', fsm: 'own', manager: true, admin: true, executive: true },
  ...
  { method: 'GET', path: '/api/exports/:id', fsm: false, manager: false, admin: true },
  { method: 'GET', path: '/api/exports/:id/download', fsm: false, manager: false, admin: true },
  { method: 'GET', path: '/api/audit', fsm: false, manager: false, admin: true },
  { method: 'POST', path: '/api/admin/integration', fsm: false, manager: false, admin: true },
  { method: 'GET', path: '/api/training', fsm: true, manager: true, admin: true },
  { method: 'GET', path: '/api/training/modules', fsm: true, manager: true, admin: true },
  { method: 'GET', path: '/api/training/tracks', fsm: true, manager: true, admin: true },
  { method: 'GET', path: '/api/training/courses', fsm: true, manager: true, admin: true },
  { method: 'GET', path: '/api/training/courses/:id', fsm: true, manager: true, admin: true },
  { method: 'GET', path: '/api/training/gates', fsm: true, manager: true, admin: true },
  { method: 'GET', path: '/api/training/gates/:userId', fsm: true, manager: true, admin: true },
  { method: 'POST', path: '/api/training/progress', fsm: true, manager: true, admin: true },
  { method: 'POST', path: '/api/training/signoff', fsm: false, manager: true, admin: true },
  { method: 'POST', path: '/api/stories/:id/consents', fsm: false, manager: true, admin: true },
  { method: 'POST', path: '/api/stories/:id/consents/:channel/withdraw', fsm: false, manager: true, admin: true },
  { method: 'GET', path: '/api/calendar/connections', fsm: true, manager: true, admin: true },
  { method: 'POST', path: '/api/calendar/connections', fsm: true, manager: true, admin: true },
  { method: 'DELETE', path: '/api/calendar/connections/:id', fsm: true, manager: true, admin: true },
  { method: 'GET', path: '/api/journeys', fsm: false, manager: true, admin: true },
  { method: 'GET', path: '/api/journeys/:id', fsm: false, manager: true, admin: true },
  ...
  { method: 'POST', path: '/api/recruitment/candidates/:id/advance', fsm: false, manager: true, admin: true },
  { method: 'POST', path: '/api/recruitment/candidates/:id', fsm: false, manager: true, admin: true },
